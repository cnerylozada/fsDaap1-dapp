    ...
    <div className="p-4">
      ...
      <div className="mb-2 p-2 border rounded-md">
        ...
        <ul className="list-disc list-inside">
          <li>
            I am a software developer with 6 years of experience. I have worked
            4 years in web2 using Next.js, TypeScript, React, React Native,
          ...
          <li>Im comfortable developing for both mobile and web platforms.</li>
          <li>
            Regarding AI, I enjoy using n8n and am currently learning LangChain
            to build more advanced AI agents.
          </li>
          <li>
            In the blockchain space, I am also exploring Rust and Solana to
